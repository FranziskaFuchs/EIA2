        ...
        if (_event.type == "change") {
            ...
            switch (target.name) {
                ...
                case "TempEndconditionDur":
                    let tempduration: HTMLParagraphElement = <HTMLParagraphElement>document.getElementById("TemperatureEndcondition");
                    tempduration.innerHTML = target.value + " min";
                    break;
                case "StirEndconditionDur":
                    let stirduration: HTMLParagraphElement = <HTMLParagraphElement>document.getElementById("StirEndcondition");
