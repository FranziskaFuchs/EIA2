...
addIngredientButton.addEventListener("click", function () {
    ...
    var ingredientUnit = availableIngredients.find(function (value) { return value.name == ingredientsName; }) ? .unit : ;
...
function displayIngredients() {
    ...
    ingredientsSteps.forEach(function (ingredientStep) {
        ...
        var price = availableIngredients.find(function (value) { return value.name == ingredientStep.name; }) ? .price : ;
